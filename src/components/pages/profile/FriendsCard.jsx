...
export default function FriendsCard ({owner}) {
  return (
          ...
          <div className="relative flex-none sm:flex">
            ...
            <div className="absolute flex flex-row w-full transform -translate-y-full">
              ...
              <div className="flex-1 inline-flex justify-end">
                <Link to={`/${owner}/friends`} className="p-1 pl-2 pr-2 m-2 text-xs text-text-white-200 leading-none bg-green-500 hover:bg-green-600 cursor-pointer rounded-full">
                  View All Friends
                </Link>
              </div>
            </div>
