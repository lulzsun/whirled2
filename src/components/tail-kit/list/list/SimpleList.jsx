...
const SimpleList = (props) => {
    ...
    return (<div className="container flex flex-col mx-auto w-full items-center justify-center bg-white dark:bg-gray-800 rounded-lg shadow">
            {props.withHeader && (<div className="px-4 py-5 sm:px-6 border-b w-full">
            ...
            <ul className="flex flex-col divide divide-y">
                {lists.map((el) => {
            return (<li className="flex flex-row" key={el.label}>
