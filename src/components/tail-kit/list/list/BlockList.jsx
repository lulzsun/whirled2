...
const BlockList = (props) => {
    ...
    return (<div className="container flex flex-col mx-auto w-full items-center justify-center">
            {props.withHeader && (<div className="px-4 py-5 sm:px-6 w-full border dark:bg-gray-800 bg-white shadow mb-2 rounded-md">
            ...
            <ul className="flex flex-col">
                {lists.map((el) => {
            return (<li className="border-gray-400 flex flex-row mb-2" key={el.label}>
                            <div className={`${props.withEffect
                    ? 'transition duration-500 shadow ease-in-out transform hover:-translate-y-1 hover:shadow-lg '
                    : 'shadow border '}select-none cursor-pointer bg-white dark:bg-gray-800 rounded-md flex flex-1 items-center p-4`}>
...
//# sourceMappingURL=BlockList.jsx.map