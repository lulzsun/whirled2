...
const PricingCard7 = () => {
    return (<div className="relative max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="bg-white dark:bg-gray-800 px-6 py-8 lg:flex-shrink-1 lg:p-12">
                    ...
                    <div className="mt-8">
                        ...
                        <ul className="mt-8 lg:grid lg:grid-cols-2 lg:col-gap-8 lg:row-gap-5">
                            {prices.map((price) => {
            return (<li className="flex items-start lg:col-span-1" key={price.label}>
                    ...
                    <div className="mt-8">
                        ...
                        <ul className="mt-8 lg:grid lg:grid-cols-2 lg:col-gap-8 lg:row-gap-5">
                            {notIncluded.map((not) => {
            return (<li className="flex items-start lg:col-span-1" key={not}>
                                        <div className="flex-shrink-0">
...
//# sourceMappingURL=PricingCard7.jsx.map