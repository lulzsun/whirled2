...
const PricingCard3 = () => {
    return (<div className="shadow-lg rounded-2xl w-64 bg-white dark:bg-gray-800 p-4">
            ...
            <button type="button" className="w-56 m-auto px-3 py-3 text-sm shadow border border-black rounded-lg text-black bg-white hover:bg-black hover:text-white dark:hover-text-gray-900 dark:hover:bg-gray-100 ">
                Request demo
            </button>

            <ul className="text-sm text-black dark:text-white w-full mt-6 mb-6">
                {includes.map((price) => {
            return (<li key={price} className="mb-3 flex items-center">
            ...
            <ul className="text-sm text-black dark:text-white w-full mt-6 mb-6">
                {bonus.map((bon, index) => {
            return (<li key={index} className="mb-3 flex items-center space-x-2">
                            ...
                            <div>
                                {bon}
                                {index === 0 && (<a href="#" className="text-red-500 font-semibold">
                                        free plan
                                    </a>)}
                            </div>
                        </li>);
...
//# sourceMappingURL=PricingCard3.jsx.map