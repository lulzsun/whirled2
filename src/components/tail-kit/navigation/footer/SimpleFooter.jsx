...
const SimpleFooter = (props) => {
    return (<footer className={`bg-white dark:bg-gray-800 w-full py-8`}>
            ...
            return (<li className="my-2" key={link.label}>
                                <a className={`text-gray-400 hover:text-gray-800 dark:text-gray-300 dark:hover:text-white transition-colors duration-200`} href={link.link || '#'}>
                                    {link.label}
                                </a>
                            </li>);
        })}
                ...
                {props.withSocial && (<div className={`pt-8 flex max-w-xs mx-auto items-center justify-between`}>
                ...
                {props.withSearch && (<div className={`text-center pt-10 sm:pt-12 font-light flex items-center justify-center`}>
                        <FormSubscribe label="Subscribe" placeholder="Email"/>
                    </div>)}
                {props.withCredits && (<div className={`text-center text-gray-500 dark:text-gray-200 pt-10 sm:pt-12 font-light flex items-center justify-center`}>
                        Created by Charlie
                    </div>)}
            </div>
        </footer>);
...
//# sourceMappingURL=SimpleFooter.jsx.map