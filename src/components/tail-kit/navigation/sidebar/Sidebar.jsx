...
const Sidebar = (props) => {
    ...
    return (<div className="relative bg-white dark:bg-gray-800">
            <div className="flex flex-col sm:flex-row sm:justify-around">
                <div className="w-72 h-screen">
                    {withHeader && (<div className="flex items-center justify-start mx-6 mt-10">
                            ...
                            {props.headerText && (<span className={`text-gray-600 dark:text-gray-300 ml-4 text-2xl font-bold`}>
                                    {props.headerText}
                                </span>)}
                        </div>)}
            ...
            return (<a key={link.label} className={`hover:text-gray-800 hover:bg-gray-100 flex items-center p-2 my-6 transition-colors dark:hover:text-white dark:hover:bg-gray-600 duration-200 ${props.withBorder && link.selected
