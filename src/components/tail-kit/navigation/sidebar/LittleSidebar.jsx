...
const LittleSidebar = (props) => {
    return (<div className="flex flex-row h-full">
            ...
            return (<li className="my-12 text-center" key={link.label}>
                                        <a href="#">
                ...
                {props.withBottomLink && (<div className="mb-4">
                        <a href="#">
                            <span>
...
//# sourceMappingURL=LittleSidebar.jsx.map