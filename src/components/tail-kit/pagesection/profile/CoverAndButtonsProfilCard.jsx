...
const CoverAndButtonsProfilCard = () => {
    return (<div className="shadow-lg rounded-2xl w-64 bg-white dark:bg-gray-800">
            ...
            <div className="flex flex-col items-center justify-center p-4 -mt-16">
                ...
                <p className="text-gray-400 text-xs flex items-center">
                    <svg width="10" height="10" fill="currentColor" className="h-4 w-4 mr-2" viewBox="0 0 1792 1792" xmlns="http://www.w3.org/2000/svg">
...
//# sourceMappingURL=CoverAndButtonsProfilCard.jsx.map