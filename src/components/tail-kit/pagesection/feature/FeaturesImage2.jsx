...
const FeaturesImage2 = () => {
    ...
    return (<div className="max-w-screen-xl p-4 bg-white dark:bg-gray-800 mx-auto px-4 sm:px-6 lg:px-8 relative py-26 lg:mt-20">
            ...
            return (<li key={index} className="mt-6 lg:mt-0">
                                        <div className="flex">
...
//# sourceMappingURL=FeaturesImage2.jsx.map