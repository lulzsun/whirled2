...
const SimpleTestimonial = (props) => {
    return (<div className={`bg-white dark:bg-gray-800 w-72 ${props.withShadow ? 'shadow-lg' : ''} mx-auto rounded-xl p-4`}>
...
//# sourceMappingURL=SimpleTestimonial.jsx.map