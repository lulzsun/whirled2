...
const NotifyMeCta = () => {
    return (<div className="px-6 py-6 bg-purple-700 dark:bg-gray-800 rounded-lg md:py-12 md:px-12 lg:py-16 lg:px-16 xl:flex xl:items-center">
...
//# sourceMappingURL=NotifyMeCta.jsx.map