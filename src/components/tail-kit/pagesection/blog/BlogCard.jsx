    ...
    return (<div className="overflow-hidden shadow-lg rounded-lg h-90 w-60 md:w-80 cursor-pointer m-auto">
            <a href="#" className="w-full block h-full">
                ...
                <div className="bg-white dark:bg-gray-800 w-full p-4">
                    ...
                    {props.showTags && (<div className="flex flex-wrap justify-starts items-center mt-4">
                            {props.tags.map((tag) => {
                return (<div key={tag} className="text-xs mr-2 py-1.5 px-4 text-gray-600 bg-blue-100 rounded-2xl">
                                        #{tag}
                                    </div>);
            })}
                        </div>)}
                    {props.showAuthor && (<div className="flex items-center mt-4">
...
//# sourceMappingURL=BlogCard.jsx.map