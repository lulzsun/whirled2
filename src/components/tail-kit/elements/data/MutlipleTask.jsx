...
const MutlipleTask = () => {
    return (<div className="shadow-lg rounded-xl w-60 md:w-72 p-4 bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-100 relative overflow-hidden">
...
//# sourceMappingURL=MutlipleTask.jsx.map