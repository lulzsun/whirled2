...
const SimplePhotoDescCard = () => {
    return (<div className="shadow-lg rounded-2xl w-64 p-4 bg-white relative overflow-hidden">
...
//# sourceMappingURL=SimplePhotoDescCard.jsx.map