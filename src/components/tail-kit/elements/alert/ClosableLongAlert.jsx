...
const ClosableLongAlert = (props) => {
    return (<div className="container bg-blue-500 flex items-center text-white text-sm font-bold px-4 py-3 relative" role="alert">
...
//# sourceMappingURL=ClosableLongAlert.jsx.map