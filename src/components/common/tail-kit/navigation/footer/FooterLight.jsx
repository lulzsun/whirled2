...
const FooterLight = (props) => {
    return (<footer className="px-3 py-8 bg-white dark:bg-gray-800 text-2 text-gray-500 dark:text-gray-200 transition-colors duration-200">
            ...
            return (<a key={link.label} aria-current="page" href={link.link || '#'} className="hover:text-gray-700 dark:hover:text-white">
                                    {link.label}
                                </a>);
        })}
                    </nav>
...
//# sourceMappingURL=FooterLight.jsx.map