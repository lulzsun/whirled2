...
const Sidebar = (props) => {
    ...
    return (<div className="bg-white dark:bg-gray-800">
            ...
            return (<Link to={link.link || '#'} key={link.label} className={`cursor-pointer select-none hover:text-gray-800 hover:bg-gray-100 flex items-center my-6 transition-colors dark:hover:text-white dark:hover:bg-gray-600 duration-200 ${props.withBorder && link.selected
                    ...
                    {props.bottomLink && (<div className="absolute bottom-0 my-10"> 
                            <Link to={props.bottomLink.link || '#'}
                                className={`select-none text-gray-600 dark:text-gray-300 hover:text-gray-800 dark:hover:text-gray-100 transition-colors duration-200 flex items-center py-2 px-8`}>
