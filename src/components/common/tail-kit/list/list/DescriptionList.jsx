...
const DescriptionList = (props) => {
    return (<div className="bg-white max-w-2xl shadow overflow-hidden sm:rounded-lg">
            {props.withHeader && (<div className="px-4 py-5 sm:px-6">
...
//# sourceMappingURL=DescriptionList.jsx.map