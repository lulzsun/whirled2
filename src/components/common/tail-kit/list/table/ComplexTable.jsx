...
const ComplexTable = (props) => {
    ...
    return (<div className="container mx-auto px-4 sm:px-8 max-w-3xl">
            <div className="py-8">
                {props.withHeader && (<div className="flex flex-row mb-1 sm:mb-0 justify-between w-full">
                    ...
                    <div className="inline-block min-w-full shadow rounded-lg overflow-hidden">
                        <table className="min-w-full leading-normal">
                            <thead>
                                <tr>
                                    {headers.map((header) => {
            return (<th scope="col" key={header} className="px-5 py-3 bg-white  border-b border-gray-200 text-gray-800  text-left text-sm uppercase font-normal">
                                                {header}
                                            </th>);
        })}
                                </tr>
            ...
            return (<tr key={row.user.name}>
                                            ...
                                            {props.withAction && (<td className="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                        ...
                        {props.withPager && (<div className="px-5 bg-white py-5 flex flex-col xs:flex-row items-center xs:justify-between">
                                <PagerButton />
                            </div>)}
                    </div>
                </div>
...
//# sourceMappingURL=ComplexTable.jsx.map