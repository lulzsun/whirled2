...
const ShippedCard = () => {
    return (<div className="shadow-lg rounded-2xl p-4 bg-white dark:bg-gray-900 w-64 m-auto relative">
            <div className="w-full h-full text-center">
                <div className="flex h-full flex-col justify-between">
                    <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" className="mt-4 w-20 h-20 m-auto text-gray-800 dark:text-white" viewBox="0 0 2048 1792">
...
//# sourceMappingURL=ShippedCard.jsx.map