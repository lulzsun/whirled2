...
const PricingCard8 = () => {
    return (<div className="w-72 mx-auto bg-white border-t-4 rounded border-indigo-500 dark:bg-gray-800 shadow text-center p-4">
...
//# sourceMappingURL=PricingCard8.jsx.map