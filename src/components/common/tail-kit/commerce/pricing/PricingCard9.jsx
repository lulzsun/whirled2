...
const PricingCard9 = () => {
    return (<div className="mx-auto bg-white h-36 w-96 rounded border-indigo-500 dark:bg-gray-800 shadow text-center p-4">
...
//# sourceMappingURL=PricingCard9.jsx.map