...
const MultipleImagesCta = (props) => {
    return (<div className={`bg-white dark:bg-gray-800 overflow-hidden relative lg:flex lg:items-center`}>
...
//# sourceMappingURL=MultipleImagesCta.jsx.map