...
const BandeauInfo = () => {
    return (<section className="max-w-screen-xl bg-green-500 dark:bg-gray-800 px-4 py-12 mx-auto sm:py-16 sm:px-6 lg:px-8 lg:py-20">
...
//# sourceMappingURL=BandeauInfo.jsx.map