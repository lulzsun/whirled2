...
const ReviewWithRate = () => {
    return (<div className="bg-gradient-to-b from-blue-500 w-full md:w-60 to-blue-600 w-full rounded-lg p-4 mb-6 shadow sm:inline-block">
...
//# sourceMappingURL=ReviewWithRate.jsx.map