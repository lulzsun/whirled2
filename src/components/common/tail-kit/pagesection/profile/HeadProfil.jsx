...
const HeadProfil = () => {
    return (<div className="w-full mx-auto max-w-xl rounded-lg bg-white dark:bg-gray-800 shadow-lg px-5 py-4 text-gray-800 dark:text-gray-50">
...
//# sourceMappingURL=HeadProfil.jsx.map