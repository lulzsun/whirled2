...
const FullPhotoCard = () => {
    return (<div className="overflow-hidden shadow-lg rounded-lg relative mb-1 mb-6 w-64 m-auto">
            ...
            <div className="absolute bg-gradient-to-b bg-opacity-60 from-transparent to-black w-full p-4 bottom-0">
                ...
                <div className="flex justify-between">
                    ...
                    <p className="text-sm text-gray-300 flex items-center">
                        <svg width="10" height="10" fill="currentColor" className="h-4 w-4" viewBox="0 0 1792 1792" xmlns="http://www.w3.org/2000/svg">
...
//# sourceMappingURL=FullPhotoCard.jsx.map