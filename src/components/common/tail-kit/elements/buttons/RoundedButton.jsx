...
const RoundedButton = (props) => {
    return (<button onClick={props.onClick} className={`${props.icon ? 'flex items-center' : ''}${props.label ? ' px-6 py-2' : ' p-4'}  transition ease-in duration-200 uppercase rounded-full hover:bg-gray-800 hover:text-white border-2 border-gray-900 focus:outline-none`}>
            {props.icon && (<svg width="20" height="20" fill="currentColor" viewBox="0 0 2304 1792" className={props.label ? 'mr-4' : ''} xmlns="http://www.w3.org/2000/svg">
...
//# sourceMappingURL=RoundedButton.jsx.map