...
const LargeDropDownMenu = (props) => {
    ...
    return (<div className="relative inline-block text-left">
            ...
            {(props.forceOpen || isOpen) && (<div ref={listElement} className="absolute z-10 -ml-4 mt-3 transform px-2 w-screen max-w-md sm:px-0 lg:ml-0 lg:left-1/2 lg:-translate-x-1/2">
                ...
                return (<a href={item.link || '#'} key={item.label} className="-m-3 p-3 flex items-center hover:bg-gray-50">
                                        {item.icon}
                                        ...
                                        <div className="ml-4">
                                            ...
                                            {item.desc && (<p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
                                                    {item.desc}
                                                </p>)}
                                        </div>
                                    </a>);
...
//# sourceMappingURL=LargeDropDownMenu.jsx.map