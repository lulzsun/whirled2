...
const DropDownMenuWithForm = (props) => {
    ...
    return (<div className="relative inline-block text-left">
            ...
            {(props.forceOpen || isOpen) && (<div className="origin-top-right border border-gray-300 absolute right-0 mt-2 w-56 rounded-md bg-white dark:bg-gray-800">
...
//# sourceMappingURL=DropDownMenuWithForm.jsx.map