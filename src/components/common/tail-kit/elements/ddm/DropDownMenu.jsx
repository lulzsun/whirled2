...
const DropDownMenu = (props) => {
    ...
    <div hidden={props.hidden} className={"relative text-left " + props.className}>
        ...
        {(props.forceOpen || isOpen) && (<div className="absolute z-10 origin-top-right right-0 mt-2 w-36 rounded-md shadow-lg bg-white dark:bg-gray-800 ring-1 ring-white ring-opacity-50">
