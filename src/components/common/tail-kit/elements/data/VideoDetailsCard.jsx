...
const VideoDetailsCard = () => {
    return (<div className="p-4 bg-white shadow-xl max-w-xl rounded-xl flex justify-start dark:bg-gray-800 md:flex-row flex-col gap-4">
...
//# sourceMappingURL=VideoDetailsCard.jsx.map