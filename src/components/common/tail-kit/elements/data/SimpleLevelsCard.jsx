...
const SimpleLevelsCard = () => {
    return (<div className="shadow-lg w-full bg-white dark:bg-gray-700 relative overflow-hidden">
...
//# sourceMappingURL=SimpleLevelsCard.jsx.map