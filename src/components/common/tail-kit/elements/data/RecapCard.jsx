...
const RecapCard = () => {
    return (<div className="shadow-lg rounded-xl bg-blue-500 w-full md:w-64 p-6 bg-white dark:bg-gray-800 relative overflow-hidden">
            ...
            <div className="mt-4">
                <button type="button" className="py-2 px-4  bg-blue-700 hover:bg-blue-800 focus:ring-blue-500 focus:ring-offset-blue-200 text-white w-full transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2 rounded-lg ">
                    Optimize
                </button>
            </div>
        </div>);
...
//# sourceMappingURL=RecapCard.jsx.map