...
const InformationModale = ({ children, withCloseBtn, onClose, withFooter }) => {
    return (<div className="-ml-5 -mt-5 absolute w-full h-full z-10">
            <div className="inset-0 overflow-y-auto">
                <div className="absolute w-full h-full inset-0 bg-gray-900 opacity-75"></div>
                    ...
                    <div className="inline-block relative overflow-hidden transform transition-all sm:align-middle sm:max-w-lg" role="dialog" aria-modal="true" aria-labelledby="modal-headline">
                        <div>
                            <div className={`${withFooter ? 'rounded-t-lg' : 'rounded-lg'} p-8 bg-white shadow`}>
                                {withCloseBtn && (<div className="absolute right-4 top-4">
                            ...
                            {withFooter && (<div className="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse rounded-b-lg">
...
//# sourceMappingURL=InformationModale.jsx.map