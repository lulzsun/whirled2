...
const Checkbox = (props) => {
    return (<div>
            ...
            return (<label key={color.label} className="flex items-center space-x-3 mb-3">
                        <input type="checkbox" name="checked-demo" className={`form-tick appearance-none bg-white bg-check h-6 w-6 border border-gray-300 rounded-md ${color.color} checked:border-transparent focus:outline-none`}/>
