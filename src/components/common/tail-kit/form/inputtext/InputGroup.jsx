...
const InputGroup = () => {
    return (<div>
            ...
            <div className="mt-1 relative rounded-md shadow-sm">
                ...
                <input type="text" name="price" id="price" className="focus:ring-indigo-500 border-l border-b border-t border-gray-300 py-2 px-4 focus:border-indigo-500 block w-full pl-7 pr-12 sm:text-sm rounded-md" placeholder="0.00"/>
